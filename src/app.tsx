...
export function App() {
  ...
  const { data: tagsResponse, isLoading, isLoadingError } = useQuery<ITagResponse>({
      ...
      <main className="max-w-6xl mx-auto space-y-5">
        {tagsResponse && !isLoadingError ? (
          <>
            ...
            <Pagination pages={tagsResponse.pages} items={tagsResponse.items} itemsShown={tagsResponse.data.length} page={page} perPage={perPage} />
